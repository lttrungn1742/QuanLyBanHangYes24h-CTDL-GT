    ...
    ui(new Ui::lsmh)
{
    ...
    initphlist(phlist);
    ui->setupUi(this);
 //   this->resize(1620,500);
    ui->scrollArea->setGeometry(0,50,1200,850);
    tatca();
    ...
    for(auto p=phlist.gettail();p!=NULL;p=p->prev){
        ...
        if(p->username==username){
            ...
            QPixmap photoPd(filePhoto);
               ...
               bill ->setText(QLocale(QLocale::English).toString(p->price.toULong()* p->quanityOfProduct)+"đ");
               ...
               name->setStyleSheet("border:none;color:black; background-color:white;");



               //thanh tien
               money->setText(QLocale(QLocale::English).toString(p->price.toULong()* p->quanityOfProduct)+"đ");
